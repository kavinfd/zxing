 ...
 * @author Sean Owen
 */
public class FinderPatternFinderPlickers {
   ...
   */
  public FinderPatternFinderPlickers(BitMatrix image) {
    this(image, null);
  }

  public FinderPatternFinderPlickers(BitMatrix image, ResultPointCallback resultPointCallback) {
    this.image = image;
